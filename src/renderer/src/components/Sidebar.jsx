  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-[8px]">
        ...
        {/* plus button */}
        <motion.button
          initial={{ height: 28, width: 28 }}
          whileHover={{ scale: 1.1 }}
          whileTap={{ scale: 0.9 }}
          animate={{ height: isExpanded == true ? 32 : 28, width: isExpanded == true ? 32 : 28 }}
          className="rounded-full bg-[#ddd] dark:bg-[#313131] relative"
        >
          <svg
            width="24px"
            height="24px"
      ...
      <div className="flex flex-col gap-[12px]">
        ...
        >
          ...
          <motion.p
            animate={{ opacity: isExpanded == true ? 1 : 0, x: isExpanded == true ? 0 : -8 }}
            className={`font-medium whitespace-nowrap text-[14px] ${isExpanded == true ? 'block' : 'hidden'}`}
          >
            Toggle Sidebar
          </motion.p>
        </motion.div>
